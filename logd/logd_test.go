...
func TestDevLog(t *testing.T) {
	...
	// => Level: app.Dev Type: DataDump Time: 2015-02-01 12:32:40:4032 Func: TestDevLog Message: JSON Request Body...
	/* <DataDump
...
func TestUserLog(t *testing.T) {
	...
	// => Level: app.User Type: Error Time: 2015-02-01 12:32:40:4032 Func: TestUserLog Message: ...
	User.Error(struct{}{}, "TestUserLog", "Error at procer", 100)
	User.Errorf(struct{}{}, "TestUserLog", "Error at %d", 100)

	// => Level: app.User Type: Info Time: 2015-02-01 12:32:40:4032 Func: TestUserLog Message: ...
	User.Info(struct{}{}, "TestUserLog", "Write to work")
	User.Infof(struct{}{}, "TestUserLog", "Write to %s", "slow")

	//dumps the given data into json formatted output
	// => Level: app.User Type: DataDump Time: 2015-02-01 12:32:40:4032 Func: TestUserLog Message:
	/* <DataDump
